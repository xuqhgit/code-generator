...
class Generator(object):
    ...
    def generate(self,input_data):
        ...
        for t in template_list:
            template_info = config["templates"][t["templateName"]]
        ...
        file_util.create_zip(code, account)

# _cur = __import__(os.path.splitext(os.path.basename(__file__))[0])
# source_data_first_handle_method  = getattr(_cur, mth)
# source_data_first_handle_method(data)




def delDir(fpath):
    path = web.web_dir + '/static/src/%s' % fpath
